...
@Composable
fun be_Screen(navController: NavController) {
    // Get the context
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.monkey), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.be_bandar) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("paa_screen") },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 16.dp)
                            .height(56.dp),
