...
@Composable
fun daaal_Screen(navController: NavController) {
    // Get the context
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.daaal_dabba), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.daaal_dabba) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("zaal_screen")
                                  showInterstitialAd()
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
