...
@Composable
fun H_Screen(navController: NavController) {
    // Get the context
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.hourse), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.h_horse) // Replace with your audio file
                    ...
                    Button(
                        onClick = {
                            navController.navigate("i_screen")
                                  showInterstitialAd()
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
