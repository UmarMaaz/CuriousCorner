...
@Composable
fun kaaf_Screen(navController: NavController) {
    // Get the context
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = { navController.navigate("urdu_letter_screen") }) {
                        Icon(
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.pigeon_images), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.kaaf_kabutar) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("gaaf_screen")
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 16.dp)
                        ...
                        Text(text = "اگلا", color = Color.White,
                            fontWeight = FontWeight.Bold,
                            fontSize = 18.sp,
                        )
                    }
