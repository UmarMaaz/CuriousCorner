...
@Composable
fun M_Screen(navController: NavController) {
    // Get the context
        ...
        content = { padding ->
            Box(
                ...
                Column(
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.m_monkey) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("n_screen") },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 16.dp)
                            .height(56.dp),
