...
@Composable
fun no4_Screen(navController: NavController) {
    // Get the context
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.four_cars), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.four_cars) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("no5_screen")
                                  showInterstitialAd()
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
