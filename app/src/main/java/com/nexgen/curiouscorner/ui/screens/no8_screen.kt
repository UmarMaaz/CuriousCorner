...
@Composable
fun no8_Screen(navController: NavController) {
    // Get the context
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.eight_chicks), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.eight_chicks) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("no9_screen")
                                  showInterstitialAd()
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
