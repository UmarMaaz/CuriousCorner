...
@Composable
fun saad_Screen(navController: NavController) {
    // Get the context
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.sandook), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.saad_sandook) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("duaad_screen")
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 16.dp)
