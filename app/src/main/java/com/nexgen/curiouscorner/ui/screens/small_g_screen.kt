...
@Composable
fun small_G_Screen(navController: NavController) {
    // Get the context
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { navController.navigate("lower_case_letter_screen") }) {
                        Icon(
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            // Large letter "A" and word "Aeroplane" at the top
                            Row(
                                horizontalArrangement = Arrangement.Start,
                                verticalAlignment = Alignment.Top, // Ensure vertical alignment is set
                            ) {
                                Text(
                                    text = "g",
                                    fontSize = 120.sp,
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.glass), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.g_glass) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("small_h_Screen") },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 16.dp)
                            .height(56.dp),
