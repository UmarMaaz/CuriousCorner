...
@Composable
fun small_P_Screen(navController: NavController) {
    // Get the context
        ...
        content = { padding ->
            Box(
                ...
                Column(
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.p_parrot) // Replace with your audio file
                    ...
                    Button(
                        onClick = {
                            navController.navigate("small_q_Screen")
                            showInterstitialAd()
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
