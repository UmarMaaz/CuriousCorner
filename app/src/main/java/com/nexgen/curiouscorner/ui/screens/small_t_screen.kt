...
@Composable
fun small_T_Screen(navController: NavController) {
        ...
        content = { padding ->
            Box(
                ...
                Column(
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.t_tree) // Replace with your audio file
                    ...
                    Button(
                        onClick = {
                            navController.navigate("small_u_Screen")
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 16.dp)
