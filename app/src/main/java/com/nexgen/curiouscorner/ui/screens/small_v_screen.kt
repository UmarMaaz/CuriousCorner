...
@Composable
fun small_V_Screen(navController: NavController) {
    // Get the context
        ...
        content = { padding ->
            Box(
                ...
                Column(
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.v_van) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("small_w_Screen") },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 16.dp)
                            .height(56.dp),
