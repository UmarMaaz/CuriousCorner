...
@Composable
fun small_X_Screen(navController: NavController) {
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.xerox), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.x_xerox) // Replace with your audio file
                    ...
                    Button(
                        onClick = {
                            navController.navigate("small_y_Screen")
                            showInterstitialAd()
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
