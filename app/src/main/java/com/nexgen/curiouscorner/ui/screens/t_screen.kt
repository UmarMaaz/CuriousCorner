...
@Composable
fun T_Screen(navController: NavController) {
        ...
        content = { padding ->
            Box(
                ...
                Column(
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.t_table) // Replace with your audio file
                    ...
                    Button(
                        onClick = {
                            navController.navigate("u_screen")
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 16.dp)
