...
@Composable
fun X_Screen(navController: NavController) {
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.xylophone), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.x_xylophone) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("y_screen")
                                  showInterstitialAd()
                                  },
                        modifier = Modifier
                            .fillMaxWidth()
