...
@Composable
fun ya_Screen(navController: NavController) {
    // Get the context
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.yakka), // Replace with your image
                            ...
                            Row(
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        mediaPlayer?.release()
                                        mediaPlayer = MediaPlayer.create(context, R.raw.ye_yakka) // Replace with your audio file
                    ...
                    Button(
                        onClick = { navController.navigate("yaa_screen")
                                  showInterstitialAd()},
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(horizontal = 16.dp)
